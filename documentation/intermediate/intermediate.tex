...
\begin{frame}
	...
	\begin{itemize}
			\item Vorteil gegenüber einzelner Übersetzung jedes Befehls: einmal übersetzte Befehle werden gecached und müssen nicht erneut übersetzt werden.
			\item Vorteil gegenüber statischer Übersetzung: Einfacher zu implementieren da konditionale Sprungziele statisch teilweise nicht feststehen.
	\end{itemize}
