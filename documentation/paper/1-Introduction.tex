...
In contrast to Intel's x86~\cite{intel2017man} it employs the RISC (Reduced Instruction Set Computer) scheme providing fewer and less powerful instructions, addressing modes etc.\ in favor of easier to implement micro architectures.
