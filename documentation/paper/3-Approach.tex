...
\begin{enumerate}
	\item Parsing the guest program's code into easy to work with internal instruction representations, until we hit the end of the basic block.
...
% todo @Johannes: Sec. 3.6.2: "the branch’s host code" -- Unverstaendlich.
