...
\newcommand{\translatorname}{"INSERT PROGRAM NAME HERE"} %todo name check all other usages of 'our translator' and such, maybe use a bit of variety by manually replacing the command usages.
...
% todo regex for : followed by capiatal @all
