...
% todo figure out which of the SPEC benchmarks to list here.
% ================================
\begin{figure}[h]
	\centering
	\begin{tikzpicture}
		\begin{axis}[%
			...
			scaled y ticks = false,
			symbolic x coords={602.gcc\_s, 605.mcf\_s, 620.omnetpp\_s, 631.deepsjeng\_s},
			ymin = 0,
			ymajorgrids = true,
			height = 6.0cm,
			width = 0.9\linewidth,
