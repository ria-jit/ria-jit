...
In most cases we can achieve a execution time of around twice the native, but the tests also show areas with further optimization possibilities. %todo speed seems strange here makes it sound like we are faster than native
...
Also there is still potential for improvement the \textit{SPEC CPU 2017} benchmarks demonstrates its usability in executing general purpose RISC--V compiled programs on a x86--64 processor. %TODO what?