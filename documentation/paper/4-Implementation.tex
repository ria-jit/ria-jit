...
%\pgfplotstabletypeset\sortedregfreqtable
	...
	\begin{tikzpicture}
		\begin{axis}[%
			title = {Register frequency},
			ybar,
			area legend,
			ylabel = {Register usage precentage},
			xtick = data,
			xticklabel style = {
				inner sep = 0pt,
				anchor = north east,
			...
			flexible xticklabels from table={\sortedregfreqtable}{[index]0},
			xtick pos=bottom,
			ymin = 0, ymax = 0.45,
			ymajorgrids = true,
			bar width = 5pt,
		...
		\addplot+[fill=era-dbt-1, draw=black]table [x expr= \coordindex, y=1]\sortedregfreqtable;
