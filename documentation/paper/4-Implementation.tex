...
\begin{table}
	...
	\caption[Register usage analysis results]%
	{The results of a static and dynamic register usage analysis of several \textit{SPEC CPU 2017} benchmarks, \textit{gzip} as well as a merge sort utility program.}
...
\begin{table}
	...
	{The static register mapping in use by the translator.}
...
\begin{table}
	...
	\caption[General system call overview]%
	{An overview of the system calls handled via pass-through to the host.}
