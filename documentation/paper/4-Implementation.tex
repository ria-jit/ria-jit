...
%\pgfplotstabletypeset\sortedregfreqtable
	...
	\begin{tikzpicture}
		\begin{axis}[%
			...
			\addplot+[fill=era-dbt-1, draw=black, restrict x to domain=0:4]table [x expr = \coordindex, y = 1]\sortedregfreqtable;
			\addplot+[fill=era-dbt-2, draw=black, restrict x to domain=5:5]table [x expr = \coordindex, y = 1]\sortedregfreqtable;
			\addplot+[fill=era-dbt-1, draw=black, restrict x to domain=6:12]table [x expr = \coordindex, y = 1]\sortedregfreqtable;
