 ...
 */
class GpToFpFloatTest :
        public ::testing::TestWithParam<
                std::tuple<t_risc_mnem, uint64_t, t_i2fResFunc, bool,
                        bool>> {
protected:
    t_risc_mnem mnem{};
    t_risc_reg_val rs1StartValue{};
    t_i2fResFunc resFunc{};
    float expectedRd;
    bool rs1Mapped{};
    bool rdMapped{};
...
context_info *GpToFpFloatTest::c_info = nullptr;
register_info *GpToFpFloatTest::r_info = nullptr;
...
INSTANTIATE_TEST_SUITE_P(FMVWX,
                         GpToFpFloatTest,
                         testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(FCVTSW,
                         GpToFpFloatTest,
                         testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(FCVTSWU,
                         GpToFpFloatTest,
                         testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(FCVTSL,
                         GpToFpFloatTest,
                         testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(FCVTSLU,
                         GpToFpFloatTest,
                         testing::Combine(
