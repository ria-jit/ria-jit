 ...
 */
namespace {
    class FClassTest : public ::testing::Test {
    protected:
        t_risc_reg src = x1;
        t_risc_reg rd = x1;
    ...
    TEST_F(FClassTest, NegativeInfinity) {
    ...
    TEST_F(FClassTest, NegativeNormal) {
        float testVal = -100.0;
    ...
    TEST_F(FClassTest, NegativeSubNormal) {
    ...
    TEST_F(FClassTest, NegativeZero) {
    ...
    TEST_F(FClassTest, PositiveZero) {
    ...
    TEST_F(FClassTest, PositiveSubNormal) {
    ...
    TEST_F(FClassTest, PositiveNormal) {
        float testVal = 100.0;
        set_fpvalue(src, get_fVal(testVal));
        execute_in_guest_context(c_info, loc);
        EXPECT_EQ(testVal, get_fpvalue(src).f);
    ...
    TEST_F(FClassTest, PositiveInfinity) {
    ...
    TEST_F(FClassTest, SignalingNAN) {
